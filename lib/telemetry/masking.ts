import { SENSITIVE_PATTERNS, FORBIDDEN_FIELDS } from './config';
...
export function maskSensitiveData(data: any): any {
  ...
  for (const [key, value] of Object.entries(data)) {
    ...
    if (FORBIDDEN_FIELDS.some(field => key.toLowerCase() === field.toLowerCase())) {
      continue;
    }
...
export function sanitizeHeaders(headers: Record<string, string | string[]>): Record<string, string | string[]> {
