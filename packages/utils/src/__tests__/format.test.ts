...
describe('Format utilities', () => {
  ...
  describe('formatRelativeTime', () => {
    ...
    it('should format relative time', () => {
      ...
      expect(formatRelativeTime(new Date('2023-12-01T12:00:00Z'))).toBe('1 month ago');
  ...
  describe('formatMessage', () => {
    ...
    it('should format with arguments', () => {
      const msg = formatMessage('ERROR', 'Error:', { code: 500 }, 'Internal Error');
      expect(msg).toContain('[ERROR] Error: {\n  "code": 500\n} Internal Error');
    });
  });
});