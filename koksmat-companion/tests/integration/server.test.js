...
describe('Koksmat Companion Server Integration', () => {
  ...
  describe('GET /api/scripts', () => {
    it('should return list of available scripts', async () => {
      ...
      scriptManager.listScripts = jest.fn().mockResolvedValue([
        'script1.js',
        'script2.js',
        'script3.mjs'
      ]);
    ...
    it('should handle errors gracefully', async () => {
      scriptManager.listScripts = jest.fn().mockRejectedValue(new Error('Failed to list'));
  ...
  describe('POST /api/scripts/execute', () => {
    ...
    it('should handle execution errors', async () => {
      scriptManager.executeScript = jest.fn().mockRejectedValue(new Error('Script failed'));
  ...
  describe('GET /api/scripts/running', () => {
    it('should return list of running scripts', async () => {
      const mockRunning = [
        { id: 'test-1', name: 'script1.js', startTime: Date.now(), duration: 1000 },
        { id: 'test-2', name: 'script2.js', startTime: Date.now(), duration: 2000 }
      ];
  ...
  describe('Socket.IO Integration', () => {
    ...
    it('should handle errors via socket', (done) => {
      scriptManager.executeScript = jest.fn().mockRejectedValue(new Error('Socket error'));
