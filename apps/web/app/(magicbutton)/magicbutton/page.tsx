    ...
    <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="border-gray-200 dark:border-gray-700 hover:border-[#233862]/30 dark:hover:border-gray-600 transition-colors">
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-300">
                  Get smart suggestions, automated workflows, and natural
          ...
          <DemoElement id="feature-scalable">
            <Card className="border-gray-200 dark:border-gray-700 hover:border-[#233862]/30 dark:hover:border-gray-600 transition-colors">
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-300">
                  Scales effortlessly from prototype to production with modern
                  infrastructure.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="bg-[#233862]/5 dark:bg-gray-800/50 rounded-2xl p-12 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
          Experience the power of AI-assisted development. Create your own Magic
          Button assistant today.
        </p>
