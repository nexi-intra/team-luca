...
import { useWhitelabel, useBranding, useRoutes, useFeatures } from '@/components/providers/WhitelabelProvider';
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {landingContent.features.map((feature, index) => {
                    ...
                    return (
                      <Card key={index} className="border-gray-200 dark:border-gray-700 hover:border-[#233862]/30 dark:hover:border-gray-600 transition-colors">
                        <CardHeader>
                          ...
                          <CardTitle className="text-[#233862] dark:text-white">{feature.title}</CardTitle>
                        </CardHeader>
                        <CardContent>
          ...
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center">
                <Badge className="mb-4" variant="secondary">Template Documentation</Badge>
                <h1 className="text-5xl font-bold mb-6 text-[#233862] dark:text-white">
                  Magic Button Assistant Template
                </h1>
                <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
                  A production-ready Next.js template for building AI-powered assistants with Anthropic Claude. 
                  Features enterprise authentication, observability, white-labeling, and more.
                </p>
                <div className="space-y-4">
                  <div className="flex gap-4 justify-center">
                    {isDevMode === null ? (
                      // Loading state
                      <Button size="lg" disabled className="bg-[#233862] hover:bg-[#233862]/90 dark:bg-white dark:hover:bg-gray-100 dark:text-[#233862]">
                      ...
                      <Button size="lg" disabled className="bg-gray-300 dark:bg-gray-700 text-gray-500 dark:text-gray-400">
