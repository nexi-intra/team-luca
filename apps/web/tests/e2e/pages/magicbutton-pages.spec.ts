...
test.describe("Magic Button Pages", () => {
  test.describe("Magic Button Home", () => {
    ...
    test("should have feature sections", async ({ page }) => {
      ...
      const featureSections = page
        .locator('[data-testid="feature"], .feature, section')
        .filter({ hasText: /feature|capability/i });
  ...
  test.describe("Authentication Demo", () => {
    test("should load auth demo page", async ({ page }) => {
      ...
      const authElements = page.locator(
        "text=/auth|login|sign|authentication/i",
      );
    ...
    test("should display auth status", async ({ page }) => {
      ...
      const authStatus = page.locator(
        '[data-testid="auth-status"], .auth-status, text=/logged|authenticated|signed/i',
      );
  ...
  test.describe("Features Page", () => {
    test("should load features page", async ({ page }) => {
      ...
      const featuresList = page
        .locator('[data-testid="features-list"], .features-list, ul, ol')
    ...
    test("should have feature toggles", async ({ page }) => {
      ...
      const toggles = page.locator(
        'button[role="switch"], input[type="checkbox"], .toggle, .switch',
      );
  ...
  test.describe("Language Settings", () => {
    test("should load language page", async ({ page }) => {
      ...
      const languageContent = page.locator(
        "text=/language|locale|translation/i",
      );
    ...
    test("should have language selector", async ({ page }) => {
      ...
      const selector = page
        ...
        .filter({ hasText: /language|locale/i });
  ...
  test.describe("Interactive Elements", () => {
    test("should handle demo interactions", async ({ page }) => {
      ...
      const buttons = page
        .locator("button")
        .filter({ hasText: /demo|try|test/i });
