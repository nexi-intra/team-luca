...
test.describe("Documentation Pages", () => {
  test.describe("Documentation Home", () => {
    test("should load docs home page", async ({ page }) => {
      ...
      const docsNav = page.locator('nav, aside').filter({ hasText: /documentation|docs/i });
  ...
  test.describe("Compliance Documentation", () => {
    const compliancePages = [
      ...
      { path: "/docs/compliance/incident-response", title: "Incident Response" },
      { path: "/docs/compliance/security-overview", title: "Security Overview" },
      { path: "/docs/compliance/security-policies", title: "Security Policies" },
  ...
  test.describe("Power Users Documentation", () => {
    const powerUserPages = [
      { path: "/docs/power-users/advanced-features", title: "Advanced Features" },
  ...
  test.describe("System Admin Documentation", () => {
    const sysAdminPages = [
      ...
      { path: "/docs/system-admins/disaster-recovery", title: "Disaster Recovery" },
  ...
  test.describe("Documentation Navigation", () => {
    test("should have working sidebar navigation", async ({ page }) => {
      ...
      const sidebar = page.locator('aside, [role="navigation"]').filter({ hasText: /docs|documentation/i });
