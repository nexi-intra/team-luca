...
test.describe("Main Application Pages", () => {
  ...
  test.describe("Dashboard", () => {
    test("should navigate to dashboard", async ({ page }) => {
      ...
      const dashboardContent = page.locator('[data-testid="dashboard-content"], main').first();
  ...
  test.describe("Settings Page", () => {
    ...
    test("should have theme toggle", async ({ page }) => {
      ...
      const themeToggle = page.locator('[data-testid="theme-toggle"], button:has-text("theme"), button[aria-label*="theme"]');
  ...
  test.describe("Accessibility Page", () => {
    test("should load accessibility page", async ({ page }) => {
      ...
      const accessibilityElements = page.locator('text=/accessibility|a11y|wcag/i');
  ...
  test.describe("Credits Page", () => {
    test("should load credits page", async ({ page }) => {
      ...
      const creditsElements = page.locator('text=/credits|acknowledgments|contributors/i');
  ...
  test.describe("Sidebar Demo Page", () => {
    ...
    test("should toggle sidebar on mobile", async ({ page }) => {
      ...
      const menuToggle = page.locator('button[aria-label*="menu"], button[aria-label*="sidebar"], [data-testid="menu-toggle"]');
